...
public sealed record TaskResponse(int Id, string Title, bool IsDone, Priority Priority, DateTime CreatedAt, int? CategoryId, CategorySummaryDto? Category, List<TagSummaryDto> Tags, List<SubtaskSummaryDto> Subtasks);
...
public static class GetTask
{
    ...
    private static async Task<IResult> Handle(int id, AppDbContext db, CancellationToken ct)
    {
        ...
        .Select(t => new TaskResponse(
            t.Id, t.Title, t.IsDone, t.Priority, t.CreatedAt, t.CategoryId,
